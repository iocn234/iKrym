...
class GoogleMap {
    ...
    function generate() {
        ...
        $out .= '	<div id="' . $this->div_id . '" class="' . $this->div_class . '" style="height:' . $this->height . ';width:' . $this->width . ';left:' .$this->left. ';"></div>';
        ...
        $out .= '	<script type="text/javascript">
    					...
    					function initialize()
    					{
                               ...
                               var myOptions = {
                                             center: new google.maps.LatLng(Geo.getCookie("userLatitude"),Geo.getCookie("userLongitude")),
                                            Zoom:' . $this->zoom . ',
